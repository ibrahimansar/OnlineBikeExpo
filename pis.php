...
$a= "INSERT INTO sample2(bikename,bikeinfo,image) values ('$t1', '$spec','$img')";
...
<input class="MyButton" type="button" value="exit" onclick="window.location.href='http://localhost/pis.html'" />
</body>
</html>
